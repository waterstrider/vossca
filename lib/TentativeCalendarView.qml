...
Rectangle {
    ...
    Component.onCompleted: {
        console.log("TentativeCalendarView loaded")
    }

    Component.onDestruction: {
        console.log("TentativeCalendarView to be destructed")
    }
    ...
    ListModel {
        ...
        Component.onCompleted: {
            ...
            for (var y = currentYear - 10; y <= currentYear + 10; y++) {
                for (var m = 0; m < 12; m++) {
                    listMonthYear.append({
                                             value: {
                                                 month: m,
                                                 year: y
                                             },
                                             text: (monthList[m].substr(
                                                        0, 3) + " " + y)
                                         })
                }
            }
        ...
        Repeater {
            ...
            WidgetButtonItem {
                ...
                onClicked: {
                    ...
                    selectionMonthYear.selectedIndex = 12
                            * (container.year - currentDate.getFullYear(
                                   ) + 10) + container.month
    ...
    WidgetSelectLeftRight {
        ...
        onSelectedItemChanged: {
            if (container.year != selectedItem) {
                ...
                selectionMonthYear.selectedIndex = 12 * (container.year - currentDate.getFullYear(
                                                             ) + 10) + container.month
            }
        }
    }
        ...
        onSelectedItemChanged: {
            if (container.month != selectedItem.month) {
                ...
                if (container.year != selectedItem.year) {
                    ...
                    selectionYear.selectedIndex = container.year - currentDate.getFullYear(
                                ) + 10
                }
            }
        }
