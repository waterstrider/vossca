...
Item {
    ...
    Image {
        ...
        Item {
            id: leftItem
            x: (leftImage.width / 2) - (leftImage.width / 2) * ((Math.min(
                                                                     _value,
                                                                     max) - min) / (max - min))
            clip: true
            height: leftImage.height
            width: (leftImage.width / 2) * ((Math.min(_value,
                                                      max) - min) / (max - min))
            Image {
                id: leftImage
                x: -((leftImage.width / 2) - (leftImage.width / 2)
                     * ((Math.min(_value, max) - min) / (max - min)))
    ...
    Image {
        ...
        Item {
            ...
            width: (rightImage.width / 2) + (rightImage.width / 2)
                   * ((Math.min(_value, max) - min) / (max - min))
            Image {
                id: rightImage
