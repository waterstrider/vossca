...
Item {
    ...
    function getCcsTmDatabase(dbName) {
        if((dbName in cachedCcsTmDatabases) && cachedCcsTmDatabases[dbName] != null)
            ...
            cachedCcsTmDatabases[dbName] = comp.createObject(null, {"context": container,
                                                               "databaseName": dbName,
                                                               "type": "QMYSQL",
                                                               "hostName": container.hostName,
                                                               "userName": container.userName,
    ...
    function getCcsTcDatabase(dbName) {
        ...
        var ccsTcDatabase = comp.createObject(null, {"context": container,
                                                           "databaseName": dbName,
                                                           "type": "QMYSQL",
                                                           "hostName": container.hostName,
                                                           "userName": container.userName,
